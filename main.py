...
#GameDesign: 
#Goals get as far up as you can 

    #   Jump and dont fall
    #   Move upwards with random platforms
    #   Score for every new platform jumped on
...
class Game:
    ...
    def new(self):
        ...
        self.bgimage = pg.image.load(os.path.join(img_folder, 'djbackground.png')).convert()
        self.score = 0
        self.all_sprites = pg.sprite.Group()
        self.all_platforms = pg.sprite.Group()
        self.all_mobs = pg.sprite.Group()
        self.all_invisible = pg.sprite.Group()
        # instantiate classes
        ...
        for i in range(0,5):
            i = invisible(randint(0, WIDTH), randint(0, math.floor(HEIGHT/2)), 20, 20, "movinginvisible")
            self.all_sprites.add(i)
            self.all_invisible.add(i)
